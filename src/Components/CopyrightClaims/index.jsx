    ...
    <>
      <div className="copyright_section">
        ...
        <p className="p_copy">
          ...
          property rights of others and may terminate your use of the Website if
          you submit any such Content.
        </p>
        ...
        <p className="space_between_bottom p_copy">
          ...
          any of your copyrighted material is being infringed on the Website, we
          have designated an agent to receive notifications of claimed copyright
          infringement. Notifications should be e-mailed to{" "}
        ...
        <ul>
          ...
          <li>
            ...
            its location or, for search results, identification of the reference
            or link to material or activity claimed to be infringing. Please
            describe the material and provide a URL or any other pertinent
        ...
        <ul>
          ...
          <li>
            ...
            that you consent to the jurisdiction of the courts in the address
            you provided, Anguilla and the location(s) in which the purported
            copyright owner is located; and
          </li>
          <li>
